            ...
            <div id="divDetailBody" class="divDetailBody">
				<table class="TableLine" border="1px" cellpadding="5px" width="100%" bordercolor="#BABAD2">
					...
					<tr>
                        ...
                        <td bgcolor="#FFFFFF">
                            <input name="Sms" type="checkbox" class="TextBox" style="width: 95%;"  value="<?echo $row["Sms"] ? "1" : "0";?>" <?if($row["Sms"] == "1") echo "checked"?>/>
                        </td>
                        <td align="center" bgcolor="#e5e5e5">
                            <span class="b_12">願意訂閱電子報(E-mail)</span>
                        </td>
                        <td bgcolor="#FFFFFF">
                            <input name="Subscribe" type="checkbox" class="TextBox" style="width: 95%;"  value="<?echo $row["Subscribe"] ? "1" : "0";?>" <?if($row["Subscribe"] == "1") echo "checked"?>/>
                        </td>
                        <td align="center" bgcolor="#e5e5e5">
