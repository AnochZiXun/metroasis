                ...
                <div class="frameBOX">
                    <div class="newsPageList">
                        <div class="col-lg-4 col-sm-6">
                           <img src="images/500px_IMG/01.jpg" class="img-responsive">
                        </div>
                        <div class="col-lg-8 col-sm-6">
                           <p class="textA">露營野趣</p><br><br>
                           <p class="textB"> 十一月份露營活動即將開放報名</p>
                           <p class="textC"><i class="fa fa-calendar" aria-hidden="true"></i> 活動日期：2017-05-05</p>
                           <p class="textD">露營初階班讓剛進入露營的營友，體驗簡單露營。 帳棚搭設、餐廚器材使用、休憩器材展示、兒童手作體驗。露營初階班讓剛進入露營的營友，體驗簡單露營。 帳棚搭設、餐廚器材使用、休憩器材展示、兒童手作體驗。</p>
                           <a href="news_detail.php"><button type="button" class="btn btn-success btn-lg" style="margin-top: 5px;">詳情內容</button></a>
                        </div>
                    </div>
                    <div class="newsPageList">
                        <div class="col-lg-4 col-sm-6">
