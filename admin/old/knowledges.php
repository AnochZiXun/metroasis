...
$query_knowledges = 'SELECT * FROM Knowledges';

if (isset($_POST["state"])){ 
	$state = $_POST["state"];	
	$query_knowledges = $query_knowledges.' where state = '.$state;	
}	
	
if (isset($_POST["searchText"])) {
	$key = trim($_POST["searchText"]);
	$query_knowledges = $query_knowledges.' and Title like "%'.$key.'%" ';	
}
    ...
    <script type="text/javascript">
        function pageInitial(){
            ...
            $(".detail").colorbox({ iframe: true, width: "100%", height: "100%", overlayClose: false, escKey: false, 
									onClosed: function () { location.href="knowledges.php"; } });
            $(".add").colorbox({ iframe: true, width: "100%", height: "100%", overlayClose: false, escKey: false, href: "knowledgesDetail.php", 
									onClosed: function () { location.href="knowledges.php"; } });
                            ...
                            <div id="divGridview" style="overflow: auto">
                                <div>
                                    <table class="GridView" cellspacing="0" cellpadding="5" rules="all" border="1" id="gvGridView"
										...
										<tr>
											<?
												$sql = "SELECT R.CodeName FROM Knowledges K LEFT JOIN RefCommon R ON K.Category = R.TypeCode 
														AND R.Type = 'knowledges' AND K.KnowledgesID=".$row["KnowledgesID"];
                                            ...
                                            <td align="center">
                                                <a id="gvGridView_ctl02_hlContents" class="detail" href="knowledgesDetail.php?KnowledgesID=<? echo $row["KnowledgesID"]; ?>">
                                                    <? echo $row["ShortTitle"]; ?>
												</a>
                                            </td>
                            ...
                            <div class="GridViewFooter">
                                <table class="TableNoLine">
                                    <tr>
                                        ...
                                        <td>
											<a href="knowledges.php?page=1">最前頁｜</a>
                                        </td>
                                        <?	
											$prePage = $page-1;
											if ($prePage < 1) {
										...
										?>
										<td>
											<a href="knowledges.php?page=<?echo $prePage?>">上頁｜</a>
                                        </td>
										<?	
											$nextPage = $page+1;
										...
										?>
                                        <td>
											<a href="knowledges.php?page=<?echo $nextPage?>">下頁｜</a>
                                        </td>
                                        <td>
											<a href="knowledges.php?page=<?echo $total_pages?>">最後頁</a>
                                        </td>
                                        <td>
