...
if(isset($_GET["productId"])) {
	...
	//查詢修改商品
	$query_product_sql = "SELECT P.ProductID, P.SortNo, P.ProductCategoryID, P.BrandID, P.ProductName,format(P.UnitPrice,0) as UnitPrice,format(P.ListPrice,0) as ListPrice,Status, P.UpdateDate,(SELECT ImageFileName FROM `ImagesFiles` WHERE `ImageFunction` = 'products' AND `ImageType` = 'detail' AND `ForeignID` = P.ProductID LIMIT 1) AS ImageFileName ";
	...
	//echo $Json;
	$deliveryMethod = $Json;
	$insert_products_sql = "INSERT INTO Products(ECPlatform,DeliveryMethod) VALUES ('$ecPlatform','$deliveryMethod')";
...
if($_POST["action"] == "update"){ 
	...
	$sortNo = $_POST["SortNo"] == '' ? NULL : $_POST["SortNo"];
	...
	if (isset($_FILES['imgFile'])) {
		...
		/*
		#echo "<script>alert('". $myFile['tmp_name'][0] ."');alert('". $myFile['name'][0] ."')</script>";
		#echo exit();'
		*/
	...
	//header("Location: productDetail5.php?productId=$productId");
	$url = "Location: products5.php?status=".$statusForBackToList;
	if($searchBarCode != ""){
...
<head id="MainMasterHead">
	...
	<script type="text/javascript" charset="UTF-8">
		...
		var loadFile = function(event,thisUploadFileBtn){
    		...
    		var uploadImgCount = document.getElementById("imgFile"+uploadCount).files.length;
		...
		function beforeSubmit(){
	    	...
	    	if($("#sortNo").val().length > 0 && ($("#sortNo").val().length == 1 || !$("#sortNo").val().substring(0,1).match("[A-J]") || !$("#sortNo").val().substring(1,2).match("[0-9]"))){
	    		alert("前台展示位置格式不符！");
	    		$("#sortNo").css("border-color","red");
	    		stopLoading();
    			return false;
	    	}else{
	    		$("#sortNo").css("border-color","");
	    	}
		...
		<div style="overflow: hidden;">
			...
			<div id="divWork" style="float: left; width: 90%">
				<div class="divWorkArea" style="height:auto; margin-bottom: 100px;">
					<div id="UpdatePanel1">
							<div style="float: left; padding-right: 10px; padding-left: 5px; padding-top: 15px;">
								<span id="LabMessage" style="color: Red; font-size: 11pt; font-weight: bold;"></span>
								<form method="post" action="products5.php?page=<? echo $page ?>" >
									...
									if($recProducts){
										...
										<tr>
											...
											<td align="left" valign="top">
												<span class="blue_14"><b><? echo $rowRecProduct["SortNo"] ? $rowRecProduct["SortNo"] : "-" ?></b></span>
                                                <br/>
										...
										<div id="divDetailBody" class="divDetailBody" style="width:100%;padding-top:0px">
											...
											<table class="TableLine" border="1px" cellpadding="5px" width="100%" bordercolor="#BABAD2">
												<tr>
													...
													<td align="center" bgcolor="#FFFFFF" style="width: 11%">
													...
													<td align="center" bgcolor="#e5e5e5" style="width: 14%">
												...
												<tr>
													<td align="center" bgcolor="#e5e5e5" style="width: 10%">
														...
														<br>
                                                        <br>
														<input type="file" name="imgFile[]" id="imgFile1" accept="image/*" onchange="loadFile(event, this)" style="width:70px" multiple>
													</td>
													<td colspan="9" >
															...
															<tr>
																...
																while($ImageRow = mysql_fetch_assoc($recImage)) {
																	...
																	<th class="thImg" style="background-color:#D9D9D9; width:16%; height:100px;">
																		<img id="image<? echo $rowCount?>" class="imgs" width="100px" height="100px" src="<? echo $ImageRow["ImageFile"]?>" />
																...
																if ($rowCount < 6){
																	for ($x = $rowCount; $x <=6; $x++){
																		?>
																		<th class="thImg" style="background-color:#D9D9D9; width:16%; height:100px;">
																			<img class="imgs" id="image<? echo $x?>" width="100px" height="100px" />
																		</th>                                           
																		<?
																	}
																}
												...
												<tr>
													...
													<td colspan="9" bgcolor="#FFFFFF" >
														<textarea name="ProductFeather" id="ProductFeather" style="width:100%" class="TextBox" rows="10" cols="100"><?echo $row["ProductFeather"]?></textarea>
													</td>
												</tr>
												<tr>
													<td align="center" bgcolor="#e5e5e5" style="width: 10%">
												...
												<tr>
													...
													<td align="center" bgcolor="#FFFFFF" style="width: 14%; text-align: center;">
														<? if($isNew || $productStatus == "3"){ ?>
													...
													<td align="center" bgcolor="#FFFFFF" colspan="2" style="text-align: center;">
														<? if($isNew || $productStatus == "3"){ ?>
															<span style="font-size: 10pt;">-</span>
														<? }else{ ?>
													...
													<td align="center" bgcolor="#FFFFFF" style="width: 15%; text-align: center;">
														<? if($isNew || $productStatus == "3"){ ?>
															<span style="font-size: 10pt;">-</span>
														<? }else{ ?>
