...
if (isset($_POST["state"])){ 
	$state = $_POST["state"];	
	$query_audio = $query_audio.' where state = '.$state;	
}	
	
if (isset($_POST["searchText"])) {
	$key = trim($_POST["searchText"]);
	$query_audio = $query_audio.' and Title like "%'.$key.'%" ';	
}
    ...
    <script type="text/javascript">
        function pageInitial(){
            ...
            $(".detail").colorbox({ iframe: true, width: "100%", height: "100%", overlayClose: false, escKey: false, 
									onClosed: function () { location.href="audio.php"; } });
            $(".add").colorbox({ iframe: true, width: "100%", height: "100%", overlayClose: false, escKey: false, href: "audioDetail.php", 
									onClosed: function () { location.href="audio.php"; } });
                            ...
                            <div id="divGridview" style="overflow: auto">
                                <div>
                                    <table class="GridView" cellspacing="0" cellpadding="5" rules="all" border="1" id="gvGridView"
										...
										<tr>
											<?
												$sql = "SELECT R.CodeName FROM Audio N LEFT JOIN RefCommon R ON N.Category = R.TypeCode 
														AND R.Type = 'audio' AND N.AudioID=".$row["AudioID"];
                                            ...
                                            <td align="center">
                                                <a id="gvGridView_ctl02_hlContents" class="detail" href="audioDetail.php?audioId=<? echo $row["AudioID"]; ?>">
                                                    <? echo $row["ShortTitle"]; ?>
												</a>
                                            </td>
                            ...
                            <div class="GridViewFooter">
                                <table class="TableNoLine">
                                    <tr>
										...
										?>
										<td>
											<a href="audio.php?page=<?echo $prePage?>">上頁｜</a>
                                        </td>
										<?	
											$nextPage = $page+1;
										...
										?>
                                        <td>
											<a href="audio.php?page=<?echo $nextPage?>">下頁｜</a>
                                        </td>
                                        <td>
											<a href="audio.php?page=<?echo $total_pages?>">最後頁</a>
                                        </td>
                                        <td>
