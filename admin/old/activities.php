...
$query_activitys = 'SELECT * FROM Activitys';
	
if (isset($_POST["searchText"])) {
	$key = trim($_POST["searchText"]);
	$query_activitys = $query_activitys.' and ActivitySubject like "%'.$key.'%" ';	
}
...
<head id="MainMasterHead">
    ...
    <script type="text/javascript">
        function pageInitial(){
            ...
            $(".detail").colorbox({ iframe: true, width: "80%", height: "100%", overlayClose: false, escKey: false, 
									onClosed: function () { location.href="news.php"; } });
            $(".add").colorbox({ iframe: true, width: "80%", height: "100%", overlayClose: false, escKey: false, href: "newsDetail.php", 
									onClosed: function () { location.href="news.php"; } });
                            ...
                            <div id="divGridview" style="overflow: auto">
                                <div>
                                    <table class="GridView" cellspacing="0" cellpadding="5" rules="all" border="1" id="gvGridView"
										...
										<tr>
											<?
												$sql = "SELECT R.CodeName FROM News N LEFT JOIN RefCommon R ON N.Category = R.TypeCode 
														AND R.Type = 'news' AND N.NewsID=".$row["NewsID"];
                                            ...
                                            <td align="center">
                                                <span class="b_12"><? echo $row["ActivityDate"]; ?></span>
                                            </td>
                                            <td align="center">
                                                <a id="gvGridView_ctl02_hlContents" class="detail" href="newsDetail.php?newsId=<? echo $row["NewsID"]; ?>">
                                                    <? echo $row["ShortTitle"]; ?>
												</a>
                                            </td>
