        ...
        <div class="row" style="margin: 0 0 30px 0;">
            <div class="frameBOX">
                    <div class="row numberBOX8" style="text-align: center;">
                      <p>本次消費總金額  <span class="numberB colorB">$2,700</span></p>
                    </div>

                    <div align="center">
                    <a type="button" class="" data-toggle="collapse" data-target="#demo">總計<span class="colorB">2</span>項商品 <i class="fa fa-chevron-down" aria-hidden="true"></i></a></div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-check" style="padding-left: 20px;">
                          <label class="form-check-label">
                            ...
                            門市取貨
                            <select class="custom-select">
                              <option selected>竹北店</option>
                              <option value="1">忠孝店</option>
                              <option value="2">高雄店</option>
                              <option value="3">台中店</option>
                            </select>
                          </label>
                        </div>
                        <div class="row numberBOX8">
                          <p class="colorC">總金額 <span>$3,000</span></p>
                          ...
                          <p class="colorB">折扣後　<span class="numberB">$2,500</span></p>
                          <p>(含運費)</p>
                        </div>
                    </div>
                    <div class="login-page">
                    <a href="product.php" class="col-md-6 col-sm-12"><input style="background-color: #e95959;" type="submit" value=" 繼續購物 "></a> <a href="https://www.pay2go.com/info/Service_intro/shopping_payment_2/member" target="_blank" class="col-md-6 col-sm-12"><input type="submit" value=" 下一步，點我進入付款頁面 > "></a>
                    </div>
                </div>
