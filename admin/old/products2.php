...
$query_product_sql = "SELECT P.ProductID, P.ProductNo,P.ProductName,format(PB.StockNumber,0) as StockNumber,PB.BarCode, PB.Color, PB.Size ,format(P.OnStoreNumber,0) as OnStoreNumber,format(P.UnitPrice,0) as UnitPrice,format(P.ListPrice,0) as ListPrice,Status, P.UpdateDate,(SELECT ImageFileName FROM `ImagesFiles` WHERE `ImageFunction` = 'products' AND `ImageType` = 'detail' AND `ForeignID` = P.ProductID LIMIT 1) AS ImageFileName ";
$productTableName = "FROM Products P INNER JOIN ProductBarCode PB ON P.ProductID = PB.ProductID ";
$query_product_sql = "$query_product_sql $productTableName WHERE 1";
$orderBy = ' order by P.ProductID, PB.BarCode  desc';
        ...
        if ($searchKey != "" ){
            switch($searchField)
            {
                case "ProductName":   
                    ...
                    break;
                case "BarCode":
					$query_product_sql = $query_product_sql.' and PB.BarCode like "%'.$searchKey.'%" ';
                    break;                
            }
        } 
    }
                    ...
                    <div id="UpdatePanel1">
                        <div class="SeachBar" style="height: 25px; padding-top: 5px">
                            ...
                            <div style="float: right">
								<input type="button" name="ibAdd" id="ibAdd"  value=" 新增商品 " onClick="javascript:location.href='productDetail2.php?productId='"/>
                            </div>
                        </div>
                                ...
                                <div>
                                    <table class="GridView" cellspacing="0" cellpadding="5" rules="all" border="1" id="gvGridView"
										...
										<tr>
                                            ...
                                            <th scope="col" style="width: 3%;">狀態</th>
											<th scope="col" style="width: 7%;">商品條碼</th>
											<th scope="col" style="width: 5%;">顏色</th>
											<th scope="col" style="width: 3%;">尺寸</th>
                                            <th scope="col" style="width: 8%;">商品圖</th>
											<th scope="col" style="width: 40%;">商品分類 / 商品名稱</th>
											<th scope="col" style="width: 5%;">網路價</th>
											<th scope="col" style="width: 5%;">市價</th>
											<th scope="col" style="width: 5%;">可售數量</th>
											<th scope="col" style="width: 7%;">更新日期</th>
											<th scope="col" style="width: 5%;">管理</th>
                                        </tr>
										...
										<tr>
                                            ...
                                            <td align="center">
                                                <input name="btnEdit" type="button" value="編輯" onclick="javascript:location.href='productDetail2.php?productId=<?echo $row["ProductID"]?>'"/><br/>
                                                <input name="btnCopy" type="button" value="複製"/>
                                            </td>
                                        </tr>
										<? } ?>
                                    </table>
                            ...
                            <div class="GridViewFooter">
                                <table class="TableNoLine">
                                    <tr>
                                        ...
                                        <td>
											<a href="products2.php?page=1">最前頁｜</a>
                                        </td>
                                        <?	
											$prePage = $page-1;
											if ($prePage < 1) {
										...
										?>
										<td>
											<a href="products2.php?page=<?echo $prePage?>">上頁｜</a>
                                        </td>
										<?	
											$nextPage = $page+1;
										...
										?>
                                        <td>
											<a href="products2.php?page=<?echo $nextPage?>">下頁｜</a>
                                        </td>
                                        <td>
											<a href="products2.php?page=<?echo $total_pages?>">最後頁</a>
                                        </td>
                                        <td>
