        ...
        <div class="row">
            ...
            <div class="row rightBOX">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="highlights.php">活動消息</a></li>
                ...
                <div class="frameBOX">
                    <div class="newsPageList">
                        <div class="col-lg-4 col-sm-6">
                           <img src="images/500px_IMG/03.jpg" class="img-responsive">
                        </div>
                        <div class="col-lg-8 col-sm-6">
                           <p class="textA">露營野趣</p><br><br>
                           <p class="textB"> 十一月份露營活動得獎人及活動花絮</p>
                           <p class="textC"><i class="fa fa-calendar" aria-hidden="true"></i> 日期：2017-05-05</p>
                           <p class="textD">露營初階班讓剛進入露營的營友，體驗簡單露營。 帳棚搭設、餐廚器材使用、休憩器材展示、兒童手作體驗。露營初階班讓剛進入露營的營友，體驗簡單露營。 帳棚搭設、餐廚器材使用、休憩器材展示、兒童手作體驗。</p>
                           <a href="highlights_detail.php"><button type="button" class="btn btn-success btn-lg" style="margin-top: 5px;">詳情內容</button></a>
                        </div>
                    </div>
                    <div class="newsPageList">
                        <div class="col-lg-4 col-sm-6">
