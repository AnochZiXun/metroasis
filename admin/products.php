...
$lastestUpdateProductId = $_SESSION["lastestUpdateProductId"];
...
$product_sql_Delete = "DELETE FROM Products WHERE NewFlag = '1' AND CreateUserID = '$currentUserID' ";
...
$query_product_sql = "SELECT P.ProductID, P.SortNo, PA.ActivityName, P.ProductCategoryID, P.BrandID, P.ProductName,IFNULL(P.UnitPrice, 0) as UnitPrice,IFNULL(P.ListPrice, 0) as ListPrice,Status, P.CreateDate, P.UpdateDate, (SELECT ImageFileName FROM `ImagesFiles` WHERE `ImageFunction` = 'products' AND `ImageType` = 'detail' AND `ForeignID` = P.ProductID ORDER BY ImageFileName DESC  LIMIT 1) AS ImageFileName ";
$productTableName = "FROM Products P LEFT JOIN PromotionalActivity PA ON P.SortNo like CONCAT(PA.Area,'%') ";
$query_product_sql = "$query_product_sql $productTableName WHERE 1 AND P.NewFlag = '0' ";
...
$query_product_sql = "P.ProductID, P.SortNo, PA.ActivityName, P.ProductCategoryID, P.BrandID, P.ProductName,IFNULL(P.UnitPrice, 0) as UnitPrice,IFNULL(P.ListPrice, 0) as ListPrice,Status, P.CreateDate, P.UpdateDate,(SELECT ImageFileName FROM ImagesFiles WHERE ImageFunction = 'products' AND ImageType = 'detail' AND ForeignID = P.ProductID LIMIT 1) AS ImageFileName, P.StartDate, P.EndDate FROM Products P LEFT JOIN PromotionalActivity PA ON P.SortNo like CONCAT(PA.Area,'%') WHERE 1";
...
if($_POST["action"] == "copy") {
	...
	header("Location: products.php?action=afterCopy");
}
//預設每頁筆數
$pageRow_records = 10;
//總筆數
													...
													<div>
														...
														if($recProducts){
															...
															<tr>
																...
																<td align="left" valign="top">
																	<span class="blue_14"><b><? echo $row["SortNo"] ? $row["ActivityName"].substr($row["SortNo"],1,2) : "" ?></b></span>
																	<br>
