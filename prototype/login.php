            ...
            <div class="row rightBOX">
                ...
                <div class="frameBOX">
                  <div class="alert alert-success" role="alert" >
                      <p><strong>注意!!</strong>每次使用或連線完畢，均登出並結束您的帳號使用。</p>
                  </div>  
                  <div class="login-page">      
                    <div class="login-body">
                        <form action="#" method="post">
                            <input type="text" class="user" name="email" placeholder="請輸入您當初註冊的E-MAIL信箱帳號。" required="">
                            <input type="password" name="password" class="lock" placeholder="字串長度必須在 8 ~ 30 個字母之間" required="">
                            ...
                            <div class="forgot-grid">
                                <label class="checkbox"><input type="checkbox" name="checkbox"><i></i>記住我</label>
                                <div class="forgot">
                                    <a href="login_forget_password.php"><i class="fa fa-question-circle" aria-hidden="true"></i> 忘記密碼?</a>
                                </div>
