<?php
	...
	$query_Aboutus = "SELECT * FROM  `Aboutus` LIMIT 0,1";
	$rec_Aboutus = mysql_query($query_Aboutus);
	$row_Aboutus = mysql_fetch_assoc($rec_Aboutus);
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="row">
            ...
            <!-- 路徑 -->
                ...
                <div class="alert alert-info" role="alert">
                    <strong><i class="fa fa-bars" aria-hidden="true"></i></strong> 關於我們
                </div>
			<!-- 第一塊大的區塊 -->
				<div class="row">
					<!--<img src="images/aboutTITLE.jpg" class="img-responsive">-->
					<? echo $row_Aboutus["AboutusHtml"]; ?>
				</div>	
           </div>
        </div>
    </div>
